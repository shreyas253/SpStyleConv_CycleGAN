...
methods = [ "./audio/Lomb_orig",
            "./audio/Norm_pred_parallel",
            "./audio/Norm_pred_inca",
            "./audio/Norm_pred_conv",
            "./audio/Norm_orig"
           ]

method_titles = ['Lombard Reference',
                 'Mapped Parallel',
                 'Mapped INCA',
                 'Mapped CycleGAN',
                 'Normal Reference']
heading =  "Lombard to Normal"
...
def parse_args(argv=None):
    ...
    parser.add_argument('--output', type=str, default="./audiotable_LN.html")
    parser.add_argument('--max_files', type=int, default=22)
